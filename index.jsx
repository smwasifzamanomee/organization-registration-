            ...
            <div className="flex justify-center min-h-screen">
                ...
                <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                    <div className="w-full">
                        {/* Client Registration */}
                        <h1 className="text-center md:text-3xl text-2xl font-semibold tracking-wider text-gray-800 capitalize dark:text-white  mb-4">Client Registration Form</h1>
                        <hr/>
                        <h1 className="mt-4 text-2xl font-semibold tracking-wider text-gray-800 capitalize dark:text-white">
                            Sign Up
                        </h1>

                        <p className="mt-4 text-gray-500 dark:text-gray-400">
                        The account opening documentation which must have been completed by you
                        </p>
                            ...
                            <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                                <div className="flex flex-col">
                                    ...
                                    <input
                                        ...
                                        // className={styles}
                                        className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-primary dark:focus:border-primary focus:ring-primary"
                                        required
